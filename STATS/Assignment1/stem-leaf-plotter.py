...
class StemPlot():
    ...
    def get_plot(self):
        ...
        for i in self.raw_data:
            ...
            # actual good way of getting the leaf digit 
            leaf = int((i / self.leaf_unit) % 10)
...
def main():
    ...
    RAW_1 = [125.25,127.5,131.5,133.25,133.5,135.75,136.25,137.25,139.25,140.25,148.0,148.5,148.75,151.25,152.75,154.0,154.25,158.25,159.25,160.25,
    160.75,162.75,164.25,168.0,173.25,176.0,179.0,179.75,180.5,181.0,181.5,182.0,183.75,184.25,184.75,186.25,187.75,191.0,191.75,195.75,196.75,
    198.0,198.25,200.5,201.25,202.25,202.5,203.0,205.0,205.25,209.25,210.25,211.75,212.0,216.0,217.0,218.5,247.25,262.75,303.15]
    RAW_1 = [int(i) for i in RAW_1]
    # 1 a
